...
public static class LayeFacts
{
    ...
    {
        return codepoint == '_' || (codepoint >= 'a' && codepoint <= 'z') || (codepoint >= 'A' && codepoint <= 'Z') || (codepoint >= '0' && codepoint <= '9');
    }
    ...
    {
        return IsIdentifierStartCharacter(codepoint);
    }
